using AutoMapper;
using LojaVirtual.CouponAPI.Config;
...
//ilder.Services.AddScoped<ICartRepository, CartRepository>();
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "lojavirtual.CouponAPI", Version = "v1" });
    c.EnableAnnotations();
